...
/** Inline icons to avoid Turbopack ESM "module factory not available" when passing refs to Sidebar/NavBar. */
...
function SteamCupIcon({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
    ...
    >
      ...
      <path d="M6 10h12l-1 8a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2l-1-8Z" />
      <path d="M18 14h1.5a1.5 1.5 0 0 0 0-3H18" />
    </svg>
  );
}
...
/**
 * Mobile main tabs (Stats, Beans, Equipment, Add)
 */
...
export function getMobileMenuItems(
  ...
  const adminItems = userRole === "super-admin" ? [navItems.admin] : [];
  return [
    ...adminItems,
...
/**
 * Desktop main navigation (Add, Beans, Equipment, Shots, Stats, Tasting)
 */
 ...
 */
export function isNavItem(item: NavItem | MenuAction): item is NavItem {
  return "href" in item;
}
