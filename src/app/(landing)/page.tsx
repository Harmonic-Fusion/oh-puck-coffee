...
export default async function LandingPage({ searchParams }: LandingPageProps) {
  ...
  // If user is logged in, redirect to the app (or callbackUrl if provided)
  if (session) {
    const redirectPath = params.callbackUrl || AppRoutes.log.path;
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-stone-300 bg-white px-4 py-2 text-sm font-medium text-stone-700 shadow-sm transition-colors hover:bg-stone-50 dark:border-stone-600 dark:bg-stone-800 dark:text-stone-200 dark:hover:bg-stone-700"
